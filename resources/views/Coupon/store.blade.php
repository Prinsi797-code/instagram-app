                    ...
                    <div class="card-body">
                        ...
                        <div class="upload-section">
                            ...
                            <div class="file-upload-wrapper">
                                ...
                                <div class="business-logo-container">
                                    <div class="placeholder-box business-logo-placeholder" id="pkg_image_url-placeholder">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="label_popular" name="label_popular"
                                value="{{ old('label_popular') }}" placeholder="Label Popular">
                            @error('label_popular')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="label_color" name="label_color"
                                value="{{ old('label_color') }}" placeholder="Label Color">
                            @error('label_color')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="price_per_coin"
                                name="price_per_coin" value="{{ old('price_per_coin') }}" placeholder="Price Per Coin">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="total_price" name="total_price"
                                value="{{ old('total_price') }}" placeholder="Total Price">
                            @error('total_price')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-square" id="product_id" name="product_id"
                                value="{{ old('product_id') }}" placeholder="Product ID">
                            @error('product_id')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
